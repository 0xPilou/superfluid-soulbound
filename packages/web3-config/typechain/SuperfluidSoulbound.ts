...
export interface SuperfluidSoulboundInterface extends utils.Interface {
  contractName: "SuperfluidSoulbound";
  functions: {
...
export interface SuperfluidSoulbound extends BaseContract {
  contractName: "SuperfluidSoulbound";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuperfluidSoulboundInterface;
