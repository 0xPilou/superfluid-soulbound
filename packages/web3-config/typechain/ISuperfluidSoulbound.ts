...
export interface ISuperfluidSoulboundInterface extends utils.Interface {
  contractName: "ISuperfluidSoulbound";
  functions: {
...
export interface ISuperfluidSoulbound extends BaseContract {
  contractName: "ISuperfluidSoulbound";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISuperfluidSoulboundInterface;
