...
export interface SuperSoulboundV1Interface extends utils.Interface {
  contractName: "SuperSoulboundV1";
  functions: {
...
export interface SuperSoulboundV1 extends BaseContract {
  contractName: "SuperSoulboundV1";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SuperSoulboundV1Interface;
