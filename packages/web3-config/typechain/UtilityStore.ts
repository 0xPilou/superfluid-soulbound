...
export interface UtilityStoreInterface extends utils.Interface {
  contractName: "UtilityStore";
  functions: {
...
export interface UtilityStore extends BaseContract {
  contractName: "UtilityStore";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UtilityStoreInterface;
