...
abstract contract SuperfluidSoulbound is ISuperfluidToken {
  ...
  /// @dev ISuperfluidSoulbound.realtimeBalanceOf implementation
  ...
  /// @dev ISuperfluidSoulbound.realtimeBalanceOfNow implementation
  ...
  /// @dev ISuperfluidSoulbound.getAccountActiveAgreements implementation
  ...
  /// @dev ISuperfluidSoulbound.createAgreement implementation
  ...
  /// @dev ISuperfluidSoulbound.getAgreementData implementation
  ...
  /// @dev ISuperfluidSoulbound.updateAgreementData implementation
  ...
  /// @dev ISuperfluidSoulbound.terminateAgreement implementation
  ...
  /// @dev ISuperfluidSoulbound.updateAgreementState implementation
  ...
  /// @dev ISuperfluidSoulbound.getAgreementState implementation
  ...
  /// @dev ISuperfluidSoulbound.settleBalance implementation
  ...
  /// @dev ISuperfluidSoulbound.makeLiquidationPayoutsV2 implementation
